<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-form-item prop="content" style="margin-bottom: 30px" label="学校介绍内容:">
...
<script>
import { SHCOOLINTRODUCE } from '@/constant/news'
...
export default {
  ...
  methods: {
    getArtical() {
      fetchNewsByCategory(SHCOOLINTRODUCE).then(({ data }) => {
