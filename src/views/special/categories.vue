...
<script>
import { fetchSpecialCategory, createSpecialCategory, updateSpecialCategory, removeSpecialCategory } from '@/api/special'
...
export default {
  ...
  methods: {
    ...
    getcategoryList() {
      ...
      fetchSpecialCategory(this.pageQuery).then(({ data }) => {
    ...
    updateImage(data) {
      updateSpecialCategory(data).then(({ message }) => {
        this.$message({
          message,
          type: 'success'
        })
    ...
    createCategoryImage() {
      createSpecialCategory(this.temp).then(({ message }) => {
        this.$message({
          message,
          type: 'success'
        })
